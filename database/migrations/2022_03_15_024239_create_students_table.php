...
class CreateStudentsTable extends Migration {
    ...
    public function up() {
        Schema::create('students', function (Blueprint $table) {
            ...
            // Secondary
            $table->boolean('k12_basic')->nulllable()->default(NULL);
            ...
            $table->integer('current_job_position')->nulllable()->default(0);
            $table->integer('first_job_position')->nulllable()->default(0);
            ...
            $table->boolean('is_archive')->nulllable()->default(0);
            $table->timestamps();
        });
    }
